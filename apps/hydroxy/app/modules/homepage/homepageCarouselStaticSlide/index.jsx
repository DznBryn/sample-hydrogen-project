...
const HomepageCarouselStaticSlide = (slideContent) => {
  const textColors = {
    eyeBrowColor: slideContent.slideContent.slideEyebrowFontColorHex
      ? slideContent.slideContent.slideEyebrowFontColorHex
      : '#FFF',
    headerColor: slideContent.slideContent.slideHeaderFontColorHex
      ? slideContent.slideContent.slideHeaderFontColorHex
      : '#FFF',
    copyColor: slideContent.slideContent.slideCopyFontColorHex
      ? slideContent.slideContent.slideCopyFontColorHex
      : '#FFF',
    ctaColor: slideContent.slideContent.slideCtaFontColorHex
      ? slideContent.slideContent.slideCtaFontColorHex
      : '#FFF',
  };
        ...
        >
          <div className={'textWrapper'}>
            ...
            <div className={'slideCopy'} style={{color: textColors.copyColor}}>
              <PortableTextCustom
                value={slideContent.slideContent.slideCopyRaw}
              />
            </div>
