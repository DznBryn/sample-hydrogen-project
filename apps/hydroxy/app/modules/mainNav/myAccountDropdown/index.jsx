...
const LoyaltyVersion = () => {
  ...
  return (
    <>
      ...
      >
        {customerData?.id !== '' ? (
          <MyAccountButton.Greetings />
        ) : (
          <MyAccountButton.MyRewards />
        )}
      </div>

      {isModalOpen && <LoyaltyModal {...loyaltyModalProps} />}
    </>
  );
};
    ...
    LoggedIn: () => (
      <>
        ...
        <div className={'accDropdown_cta accDropdownloggedIn'}>
          <Link reloadDocument to={'/account?c=rewards'}>
            Redeem Points
          </Link>
...
const Icons = {
  ...
  Star: () => (
    ...
    >
      <path
        d="M8.81246 11L5.44578 8.41543L2.01408 10.9045L3.32168 6.75379L0 4.10616L4.17483 4.12542L5.55361 0L6.82619 4.16266L11 4.26063L7.61168 6.81403L8.81246 11Z"
        fill="white"
      />
    </svg>
  ),
  ...
  SimpleArrowDown: () => (
    ...
    >
      <path
        d="M3.8578 0.421066C3.72932 0.424113 3.60592 0.474894 3.51249 0.56326L0.262493 3.68326C0.0563258 3.88334 0.0502284 4.2124 0.249289 4.41959C0.448865 4.62679 0.777921 4.63338 0.985623 4.43483L3.87409 1.66011L6.76256 4.43483C6.97026 4.63338 7.29983 4.62679 7.49889 4.41959C7.69796 4.2124 7.69237 3.88334 7.48569 3.68326L4.23569 0.56326C4.13413 0.466775 3.99804 0.415489 3.85789 0.421066L3.8578 0.421066Z"
        fill={'white'}
      />
    </svg>
  ),
