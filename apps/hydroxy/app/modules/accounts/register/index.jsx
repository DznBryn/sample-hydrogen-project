          ...
          >
            ...
            {ENVS?.SITE_NAME.includes('UK') ? (
              <p className={'infoText'}>
                ...
                controller. By registering for an account, you acknowledge: You
                would like to receive emails, offers, and coupons from TULA UK.
                You can exercise your{' '}
                <a href="/pages/privacy-policy#content-section-nine">
                  Data Protection Rights
                </a>{' '}
                or change your preferences and subscriptions by{' '}
                <a href="/pages/privacy-policy#content-section-fifteen">
                  clicking here.
                </a>{' '}
                You are at least 16 and have read and agree to the{' '}
                <a href="/pages/terms-conditions">Tula Terms & Conditions</a>{' '}
                and <a href="/pages/privacy-policy">Privacy Policy.</a>
                To better customize our communications to your interests, we
                will{' '}
                <a href="/pages/privacy-policy#content-section-fifteen">
                  combine the data
                </a>{' '}
                you are providing above with other data we may have collected
                about you from multiple sources and third parties.
              </p>
            ) : (
              <p className={'infoTextAlt'}>
                ...
                TULA Skincare <a href="/pages/privacy-policy">Privacy Policy</a>
                .
              </p>
            )}
  ...
  if (getApiKeys().FEATURE_FLAGS.LOYALTY) {
    return (
      <>
        <div className={'header__banner'}>
          ...
          <p>
            Start earning points online and in store, choose your favorite
            rewards, and gain exclusive access
          </p>
          <Icons.ArrowDown />
        </div>
        <div className={'header__title'}>Create an account</div>
        <p className={'header__copy'}>
          earn rewards, check your orders & manage auto-deliveries in one
          convenient place
        </p>
      </>
    );
    ...
    return (
      <>
        <div className={'header__title'}>Create an account</div>
        <p className={'header__copy'}>
          easily check your orders & manage <br />
          auto-deliveries in one convenient place
        </p>
      </>
    );
  }
...
const Icons = {
  ArrowDown: () => (
    ...
    >
      <path
        d="M1.83301 1.875L11.4997 11.5417L21.1663 1.875"
        stroke="white"
        strokeWidth={2}
        strokeLinecap="round"
...
export function RegisterForm({fetcher = useFetcher()}) {
  ...
  return (
    ...
    >
      ...
      <Button
        type="submit"
        className={`button ${disableLoginButton && 'disabledButton'}`}
        color="blue"
      ...
      {ENVS?.SITE_NAME.includes('UK') ? (
        <p className={'infoText'}>
          You are registering as a user of Tula UK for which{' '}
          <a href="/pages/privacy-policy">Tula Life, Inc.</a> is the data
          controller. By registering for an account, you acknowledge: You would
          like to receive emails, offers, and coupons from TULA UK. You can
          exercise your{' '}
          <a href="/pages/privacy-policy#content-section-nine">
            Data Protection Rights
          </a>{' '}
          ...
          You are at least 16 and have read and agree to the{' '}
          <a href="/pages/terms-conditions">Tula Terms & Conditions</a> and{' '}
          <a href="/pages/privacy-policy">Privacy Policy.</a>
          To better customize our communications to your interests, we will{' '}
          <a href="/pages/privacy-policy#content-section-fifteen">
            combine the data
          </a>{' '}
          you are providing above with other data we may have collected about
          you from multiple sources and third parties.
        </p>
      ) : (
        <p className={'infoTextAlt'}>
          By registering, I agree to receive emails from TULA Skincare. I have
          read and agree to the TULA Skincare{' '}
          <a href="/pages/terms-conditions">Terms & Conditions</a> and TULA
          Skincare <a href="/pages/privacy-policy">Privacy Policy</a>.
        </p>
      )}
    </fetcher.Form>
  );
