...
const MainNavMobileOverlay = ({mobileOverlayItems, mobileNavMainButton}) => {
  ...
  useEffect(() => {
    bindCustomEvent(overlayRef, 'data-visible-state', {
      hidden: 'hidden',
      visible: 'mainNavMobileOverlay_visible',
    });
  }, []);

  return (
    <div
      className={'overlayWrap hidden'}
      id="mobileOverlayWrapper"
      data-visible-state="hidden"
      ref={overlayRef}
    >
...
const Navigation = ({overlayItems}) => {
  ...
  const LinkButton = ({navItem, idx}) => (
    <Link reloadDocument to={navItem.linkUrl} style={{zIndex: idx.toString()}}>
      <div
        className={'navItem nav_click_hamburger_t1'}
        onClick={handleClickOnLink}
      >
    ...
    <div className={'navGroupItems'}>
      {navItem.dropdownOverlay?.overlayNavLinks.map((navLink) => (
        <Link reloadDocument to={navLink.url} key={navLink.displayText}>
          <div
            className={'navGroupItem nav_click_hamburger_t2'}
            onClick={handleClickOnLink}
          >
            {navLink.displayText}
            {navLink.calloutText && (
              <span
                className={'callout'}
                style={{
                  color: navLink?.calloutFontColorHex
                    ? navLink?.calloutFontColorHex
                    : '',
                }}
              >
                {navLink.calloutText}
...
const icons = {
  arrow: (
    ...
    >
      <path
        d="M7.89127 1.57816L12.9954 7.25803L7.89127 12.9379M1.32877 7.25803H12.9954H1.32877Z"
        stroke="#47C6D9"
        strokeWidth={2}
        strokeLinecap="round"
  ...
  flux: (
    ...
    >
      <path
        d="M14.0974 11.2504C14.6209 11.185 15.0105 10.7348 14.9997 10.2075V7.00069C14.9997 6.47044 14.7888 5.9617 14.4138 5.58672C14.0388 5.21174 13.5301 5.0008 12.9998 5.0008H9.75003C9.46684 4.99982 9.19636 5.11798 9.00592 5.32696C8.8155 5.5369 8.72273 5.81618 8.75008 6.09839C8.81551 6.62181 9.26568 7.01141 9.793 7.00069H11.5859L5.7932 12.7934C5.40162 13.184 5.40162 13.8168 5.7932 14.2073C6.1838 14.5989 6.81659 14.5989 7.20717 14.2073L12.9998 8.41566V10.2505C12.9989 10.5337 13.117 10.8042 13.326 10.9946C13.5359 11.185 13.8152 11.2778 14.0974 11.2505V11.2504Z"
        fill="#48C6D9"
      />
      <path
        d="M0.902516 3.25084C0.379095 3.31627 -0.0105083 3.76644 0.000216117 4.29376V7.50058C0.000216117 8.03083 0.211142 8.53958 0.586133 8.91456C0.961125 9.28953 1.46988 9.50047 2.00011 9.50047H5.24992C5.53311 9.50145 5.80359 9.38329 5.99403 9.17432C6.18445 8.96437 6.27722 8.68509 6.24987 8.40288C6.18444 7.87946 5.73427 7.48986 5.20695 7.50058H3.41505L9.20673 1.70791C9.3952 1.52042 9.50066 1.26653 9.50066 1.00092C9.50066 0.735309 9.3952 0.481423 9.20673 0.293934C9.01924 0.105467 8.76536 0 8.49974 0C8.23413 0 7.98025 0.105464 7.79276 0.293934L2.00008 6.08561V4.25076C2.00106 3.96758 1.8829 3.6971 1.67392 3.50666C1.46397 3.31624 1.1847 3.22347 0.902491 3.25082L0.902516 3.25084Z"
        fill="#48C6D9"
      />
    </svg>
  ),
  chat: (
    ...
    >
      <path
        d="M12.4998 0H2.50018C1.8369 0 1.20115 0.263672 0.732424 0.732424C0.263702 1.20118 0 1.83693 0 2.50018V10.0002C0.000585934 10.5539 0.185161 11.0924 0.524418 11.5307C0.863675 11.9684 1.33888 12.2819 1.87501 12.4213V12.866C1.87501 13.4766 2.24239 14.0268 2.80665 14.26C3.37033 14.4938 4.01896 14.3649 4.45081 13.933L5.88403 12.4998H12.4998C13.1631 12.4998 13.7989 12.2367 14.2676 11.768C14.7363 11.2992 15 10.6629 15 10.0002V2.50018C15 1.8369 14.7363 1.20115 14.2676 0.732424C13.7988 0.263702 13.1631 0 12.4998 0