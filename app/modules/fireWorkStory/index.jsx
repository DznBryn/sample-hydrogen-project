...
const FireWorkStory = ({ playlist, id, autoplay = false }) => {
  ...
  return (
    (playlist) ? (
      <fw-storyblock channel="tula135020676" playlist={id} branding="false" autoplay={autoplay}></fw-storyblock>
    ) : (
      <fw-storyblock channel="tula135020676" video={id} branding="false" autoplay={autoplay} max_videos="1"></fw-storyblock>
    )
  );
};
