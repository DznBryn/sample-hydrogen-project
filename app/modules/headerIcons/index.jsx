...
// import getApiKeys from '~/modules/getApiKeys';
...
const HeaderIcons = ({ hideSearch, fixedRight, lpMinimalHeader }) => {
// const HeaderIcons = ({ cartConfig, hideSearch, fixedRight, lpMinimalHeader, products }) => {
  ...
  function getTotalItemsOnCart() {
    ...
    // const IS_GWP_PRODUCT_ON_CART = (items.some(product => ((apiType === 'graphql') ? convertStorefrontIdToExternalId(product.variant.product.id) : product.variant_id) === GWP_PRODUCT_VARIANT_ID));
