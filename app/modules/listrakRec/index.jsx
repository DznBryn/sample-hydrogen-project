    ...
    if (recs.length === 0 && recs.length < 3) {
      setTimeout(() => {
        document.querySelectorAll('.product_img').forEach((elem) => {
          if (recs.indexOf(elem.href) === -1 && elem.href.indexOf('@Recommendation.LinkUrl') === -1) {
            recs.push(elem.href);
          }
        });
        listLoading = true;
  ...
  return (
    <div className={'listrakRecWrap'}>
      <div className={'listrackWrap'}>
        <div className="product-grid product_list" data-ltk-merchandiseblock={listrackConfig?.listrakId} data-quickbuy-wrapper>
          <script type="text/html">
            <div className="item product product_item" data-quickbuy="true" data-handle="@Recommendation.Meta5">
              ...
              <div className="product_info">
                <h4>
                  <a href="@Recommendation.LinkUrl">
                    @(Recommendation.Meta1 != &quot;null&quot; ? &apos;<span className="alt-title">&apos; + Recommendation.Meta1 + &apos;</span>&apos; : &apos;&apos;)
          ...
          <div className={'listProducts'}>
            ...
            {(recProducts.length > 0) &&
              recProducts.map((product) => {
                return <PLPProductBox product={prepProduct(product)} key={product.handle} />;
              })
            }
          </div>
        </div>
