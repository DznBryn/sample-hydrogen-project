...
import { getCurrency, showPaymentPlanVendor } from '~/utils/functions/eventFunctions';
...
const PDPPrice = ({
  ...
  const isGiftCard = tags.find(tag => tag.toLowerCase().replace(' ', '-') === 'gift-card');

  const promoTextStyles = isStickyCta === true
    ? 'secondary promo stickyPromo'
    : 'secondary promo';

  const sellingPlanID = store?.productPage?.addToCart?.selling_plan_id;
  const showAfterpay = !sellingPlanID || sellingPlanID === 0 && (!getApiKeys().CURRENT_ENV.includes('UK'));
  ...
  useEffect(() => {
    ...
    if (window && tulaSiteWide.current === null && window?.localStorage?.getItem('tulaSitewide') !== null) {
      tulaSiteWide.current = JSON.parse(window.localStorage.getItem('tulaSitewide'));
    }
  }, [discount, price]);
            ...
            !tags.find((tag) => tag.toLowerCase() === 'no-promo') ? (
              <>
                ...
                {originalPrice > price && (
                  ...
                  ({getCurrency() + isRemainder(parseFloat(originalPrice).toFixed(2))} value)
                  </span>
                )}
              </>
            ) : promos?.showPromo &&
            !tags.find((tag) => tag.toLowerCase() === 'no-promo') && promos?.variantIds?.find(
...
const IconAfterpay = () => (
  <svg version="1.1" id="Afterpay_Logo_Black" className={'afterpay'} x="0px" y="0px" viewBox="0 0 1165.5 234.5" >
    <g>
      ...
      <g>
        <g>
          <path d="M103,117.5c0-20-14.5-34-32.3-34s-32.3,14.3-32.3,34c0,19.5,14.5,34,32.3,34S103,137.5,103,117.5 M103.3,176.9v-15.4
          ...
          <path d="M274.5,150.5c-10.2,0-13.1-3.8-13.1-13.8V84h18.8V58.1h-18.8v-29h-29.9v29h-38.6V46.3c0-10,3.8-13.8,14.3-13.8h6.6v-23
				...
				L274.5,150.5z"/>
          <path d="M381.9,106.8c-2.1-15.4-14.7-24.7-29.5-24.7c-14.7,0-26.9,9-29.9,24.7H381.9z M322.2,125.3c2.1,17.6,14.7,27.6,30.7,27.6
          ...
          <path d="M604.4,117.5c0-19.2-14.5-34-32.3-34s-32.3,14.3-32.3,34c0,19.5,14.5,34,32.3,34S604.4,136.8,604.4,117.5 M510.3,225.4
				V58.1h29.2v15.4c8.8-10.9,21.9-17.6,37.5-17.6c32.1,0,57.3,26.4,57.3,61.3s-25.7,61.5-58,61.5c-15,0-27.3-5.9-35.9-15.9v62.5
				h-30.1V225.4z"/>
          <path d="M739.6,117.5c0-20-14.5-34-32.3-34s-32.3,14.3-32.3,34c0,19.5,14.5,34,32.3,34S739.6,137.5,739.6,117.5 M739.9,176.9
				v-15.4c-8.8,10.7-21.9,17.3-37.5,17.3c-32.6,0-57.3-26.1-57.3-61.3c0-34.9,25.7-61.5,58-61.5c15.2,0,28,6.7,36.8,17.1v-15h29.2
				v118.8L739.9,176.9L739.9,176.9z"/>
          <path d="M457.6,69.7c0,0,7.4-13.8,25.7-13.8c7.8,0,12.8,2.7,12.8,2.7v30.3c0,0-11-6.8-21.1-5.4s-16.5,10.6-16.5,23v70.3h-30.2
