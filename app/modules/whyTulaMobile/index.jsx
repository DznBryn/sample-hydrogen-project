  ...
  return (
      <div className={"whyTulaMobile"}>
        ...
        <div className={"blockOne"}>
          <img className={"whyImages"} src={content[0].imageOneMobile.asset.url} alt="Why Tula" />
        ...
        <div className={"blockTwo"}>
          <img className={"whyImages"} src={content[0].imageTwoMobile.asset.url} alt="Why Tula" />
          <div className={"container"}>
            <h2>
        ...
        <div className={"blockThree"}>
          <img className={"whyImages"} src={content[0].imageThreeMobile.asset.url} alt="Why Tula" />
          <div className={"container"}>
            <h2>
              what does clean mean at TULA?
            </h2>
            <p>
        ...
        <div className={"blockFour"}>
          <img className={"whyImages"} src={content[0].imageFourMobile.asset.url} alt="Why Tula" />
          <div className={"container"}>
            <h2>
              #EmbraceYourSkin
            </h2>
            ...
            <p className={"slideFirstHeader"}>
              We Promise to
            </p>
            <p className={"slideSubheader"}>
