...
export const meta = () => [
  ...
  {
    description: 'Tula Privacy Policy This Privacy Policy describes how Tula Life, Inc. and any of its subsidiaries and affiliates (“Tula,” “we,” “us,” and/or “our”) handle personal data we collect online (e.g., through our websites) and offline (e.g., through customer support channels, retail locations where our products are sold...',
  },
];
